...
namespace AlomaCare.Data.Migrations
{
    ...
    [Migration("20250728192344_AddBase64StringListInOutcome")]
    partial class AddBase64StringListInOutcome
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlomaCare.Models.DTOs.PatientCompleteInfoDTO", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("CongenitalInfection")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PatientCompleteInfoDTO");
                });

            modelBuilder.Entity("AlomaCare.Models.DiagnosisTreatmentForm", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CranialUltrasoundInfoId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CribScoreId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("NeonatalSepsisId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("OtherNeonatalComplicationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("RespiratoryComplicationsId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("CranialUltrasoundInfoId")
                        .IsUnique();

                    b.HasIndex("CribScoreId")
                        .IsUnique();

                    b.HasIndex("NeonatalSepsisId")
                        .IsUnique();

                    b.HasIndex("OtherNeonatalComplicationId")
                        .IsUnique();
                    ...
                    b.HasIndex("RespiratoryComplicationsId")
                        .IsUnique();

                    b.ToTable("DiagnosisTreatmentForms");
                });
            ...
            modelBuilder.Entity("AlomaCare.Models.DTOs.PatientCompleteInfoDTO", b =>
                {
                    b.HasOne("AlomaCare.Models.Patient", "Patient")
                        ...
                        .HasForeignKey("AlomaCare.Models.DTOs.PatientCompleteInfoDTO", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AlomaCare.Models.DiagnosisTreatmentForm", b =>
                {
                    b.HasOne("AlomaCare.Models.CranialUltrasoundInfo", "CranialUltrasoundInfo")
                        .WithOne()
                        .HasForeignKey("AlomaCare.Models.DiagnosisTreatmentForm", "CranialUltrasoundInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AlomaCare.Models.CRIBScore", "CribScore")
                        .WithOne()
                        .HasForeignKey("AlomaCare.Models.DiagnosisTreatmentForm", "CribScoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AlomaCare.Models.NeonatalSepsis", "NeonatalSepsis")
                        .WithOne()
                        .HasForeignKey("AlomaCare.Models.DiagnosisTreatmentForm", "NeonatalSepsisId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AlomaCare.Models.OtherNeonatalComplication", "OtherNeonatalComplication")
                        .WithOne()
                        .HasForeignKey("AlomaCare.Models.DiagnosisTreatmentForm", "OtherNeonatalComplicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AlomaCare.Models.Outcome", "Outcome")
                        .WithOne()
                        .HasForeignKey("AlomaCare.Models.DiagnosisTreatmentForm", "OutcomeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AlomaCare.Models.Patient", "Patient")
                        .WithOne()
                        .HasForeignKey("AlomaCare.Models.DiagnosisTreatmentForm", "PatientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("AlomaCare.Models.RespiratoryComplications", "RespiratoryComplications")
                        .WithOne()
                        .HasForeignKey("AlomaCare.Models.DiagnosisTreatmentForm", "RespiratoryComplicationsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CranialUltrasoundInfo");

                    b.Navigation("CribScore");

                    b.Navigation("NeonatalSepsis");

                    b.Navigation("OtherNeonatalComplication");

                    b.Navigation("Outcome");

                    b.Navigation("Patient");

                    b.Navigation("RespiratoryComplications");
                });
