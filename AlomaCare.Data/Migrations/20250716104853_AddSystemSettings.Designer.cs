...
namespace AlomaCare.Data.Migrations
{
    ...
    [Migration("20250716104853_AddSystemSettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlomaCare.Models.OtherNeonatalComplication", b =>
                {
                    ...
                    b.Property<int?>("InotropicSupportOptionId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NonLifeThreat")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("OtherSurgery")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("aEEGFinding")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("OtherNeonatalComplicationId");

                    b.HasIndex("AEEGOptionId");

                    b.HasIndex("BloodTransfusionOptionId");

                    b.HasIndex("CerebralCoolingOptionId");

                    b.HasIndex("CoolingTypeOptionId");

                    b.HasIndex("ExchangeTranfusionOptionId");

                    b.HasIndex("FreshFrozenPlasmaOptionId");

                    b.HasIndex("HIEOptionId");

                    b.HasIndex("IbuprofenForPDAOptionId");

                    b.HasIndex("InotropicSupportOptionId");

                    b.HasIndex("KangarooCareOptionId");

                    b.HasIndex("MajorBirthDefectOptionId");

                    b.HasIndex("MaxTotalBilirubinLevelOptionId");

                    b.HasIndex("NecrotisingEntrocoliisOptionId");

                    b.HasIndex("NeonatalJaundiceRequirementOptionId");

                    b.HasIndex("PDALitigationOptionId");

                    b.HasIndex("ParacetamolForPDAOptionId");

                    b.HasIndex("ParentalNutritionOptionId");

                    b.HasIndex("PlateletTranfusionOptionId");

                    b.HasIndex("ROPFindingsOptionId");

                    b.HasIndex("ROPSurgeryOptionId");

                    b.HasIndex("ReasonForNotCoolingOptionId");

                    b.HasIndex("RetinopathyOfPrematurityOptionId");

                    b.HasIndex("TypeOfKMCOptionId");

                    b.HasIndex("TypeOfNECSurgeryOptionId");

                    b.HasIndex("WhyaEEGNotDoneOptionId");
            ...
            modelBuilder.Entity("AlomaCare.Models.OtherNeonatalComplication", b =>
                {
                    b.HasOne("AlomaCare.Models.AEEGOption", "AEEGOption")
                        .WithMany()
                        .HasForeignKey("AEEGOptionId");

                    b.HasOne("AlomaCare.Models.BloodTransfusionOption", "BloodTransfusionOption")
                        .WithMany()
                        .HasForeignKey("BloodTransfusionOptionId");

                    b.HasOne("AlomaCare.Models.CerebralCoolingOption", "CerebralCoolingOption")
                        .WithMany()
                        .HasForeignKey("CerebralCoolingOptionId");

                    b.HasOne("AlomaCare.Models.CoolingTypeOption", "CoolingTypeOption")
                        .WithMany()
                        .HasForeignKey("CoolingTypeOptionId");

                    b.HasOne("AlomaCare.Models.ExchangeTranfusionOption", "ExchangeTranfusionOption")
                        .WithMany()
                        .HasForeignKey("ExchangeTranfusionOptionId");

                    b.HasOne("AlomaCare.Models.FreshFrozenPlasmaOption", "FreshFrozenPlasmaOption")
                        .WithMany()
                        .HasForeignKey("FreshFrozenPlasmaOptionId");

                    b.HasOne("AlomaCare.Models.HIEOption", "HIEOption")
                        .WithMany()
                        .HasForeignKey("HIEOptionId");

                    b.HasOne("AlomaCare.Models.IbuprofenForPDAOption", "IbuprofenForPDAOption")
                        .WithMany()
                        .HasForeignKey("IbuprofenForPDAOptionId");

                    b.HasOne("AlomaCare.Models.IntropicSupportOption", "IntropicSupportOption")
                        .WithMany()
                        .HasForeignKey("InotropicSupportOptionId");

                    b.HasOne("AlomaCare.Models.KangarooCareOption", "KangarooCareOption")
                        .WithMany()
                        .HasForeignKey("KangarooCareOptionId");

                    b.HasOne("AlomaCare.Models.MajorBirthDefectOption", "MajorBirthDefectOption")
                        .WithMany()
                        .HasForeignKey("MajorBirthDefectOptionId");

                    b.HasOne("AlomaCare.Models.MaxTotalBilirubinLevelOption", "MaxTotalBilirubinLevelOption")
                        .WithMany()
                        .HasForeignKey("MaxTotalBilirubinLevelOptionId");

                    b.HasOne("AlomaCare.Models.NecrotisingEntrocoliisOption", "NecrotisingEntrocoliisOption")
                        .WithMany()
                        .HasForeignKey("NecrotisingEntrocoliisOptionId");

                    b.HasOne("AlomaCare.Models.NeonatalJaundiceRequirementOption", "NeonatalJaundiceRequirementOption")
                        .WithMany()
                        .HasForeignKey("NeonatalJaundiceRequirementOptionId");

                    b.HasOne("AlomaCare.Models.PDALitigationOption", "PDALitigationOption")
                        .WithMany()
                        .HasForeignKey("PDALitigationOptionId");

                    b.HasOne("AlomaCare.Models.ParacetamolForPDAOption", "ParacetamolForPDAOption")
                        .WithMany()
                        .HasForeignKey("ParacetamolForPDAOptionId");

                    b.HasOne("AlomaCare.Models.ParentalNutritionOption", "ParentalNutritionOption")
                        .WithMany()
                        .HasForeignKey("ParentalNutritionOptionId");

                    b.HasOne("AlomaCare.Models.PlateletTranfusionOption", "PlateletTranfusionOption")
                        .WithMany()
                        .HasForeignKey("PlateletTranfusionOptionId");

                    b.HasOne("AlomaCare.Models.ROPFindingsOption", "ROPFindingsOption")
                        .WithMany()
                        .HasForeignKey("ROPFindingsOptionId");

                    b.HasOne("AlomaCare.Models.ROPSurgeryOption", "ROPSurgeryOption")
                        .WithMany()
                        .HasForeignKey("ROPSurgeryOptionId");

                    b.HasOne("AlomaCare.Models.ReasonForNotCoolingOption", "ReasonForNotCoolingOption")
                        .WithMany()
                        .HasForeignKey("ReasonForNotCoolingOptionId");

                    b.HasOne("AlomaCare.Models.RetinopathyOfPrematurityOption", "RetinopathyOfPrematurityOption")
                        .WithMany()
                        .HasForeignKey("RetinopathyOfPrematurityOptionId");

                    b.HasOne("AlomaCare.Models.TypeOfKMCOption", "TypeOfKMCOption")
                        .WithMany()
                        .HasForeignKey("TypeOfKMCOptionId");

                    b.HasOne("AlomaCare.Models.TypeOfNECSurgeryOption", "TypeOfNECSurgeryOption")
                        .WithMany()
                        .HasForeignKey("TypeOfNECSurgeryOptionId");

                    b.HasOne("AlomaCare.Models.WhyaEEGNotDoneOption", "WhyaEEGNotDoneOption")
                        .WithMany()
                        .HasForeignKey("WhyaEEGNotDoneOptionId");

                    b.Navigation("AEEGOption");

                    b.Navigation("BloodTransfusionOption");

                    b.Navigation("CerebralCoolingOption");

                    b.Navigation("CoolingTypeOption");

                    b.Navigation("ExchangeTranfusionOption");

                    b.Navigation("FreshFrozenPlasmaOption");

                    b.Navigation("HIEOption");

                    b.Navigation("IbuprofenForPDAOption");

                    b.Navigation("IntropicSupportOption");

                    b.Navigation("KangarooCareOption");

                    b.Navigation("MajorBirthDefectOption");

                    b.Navigation("MaxTotalBilirubinLevelOption");

                    b.Navigation("NecrotisingEntrocoliisOption");

                    b.Navigation("NeonatalJaundiceRequirementOption");

                    b.Navigation("PDALitigationOption");

                    b.Navigation("ParacetamolForPDAOption");

                    b.Navigation("ParentalNutritionOption");

                    b.Navigation("PlateletTranfusionOption");

                    b.Navigation("ROPFindingsOption");

                    b.Navigation("ROPSurgeryOption");

                    b.Navigation("ReasonForNotCoolingOption");

                    b.Navigation("RetinopathyOfPrematurityOption");

                    b.Navigation("TypeOfKMCOption");

                    b.Navigation("TypeOfNECSurgeryOption");

                    b.Navigation("WhyaEEGNotDoneOption");
                });
